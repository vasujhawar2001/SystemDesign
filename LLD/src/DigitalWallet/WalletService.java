...
public class WalletService {
    ...
    public void createWallet(String name, BigDecimal amount) {
        Wallet account = new Wallet(name, amount);
    ...
    public void transfer(int fromAccNum, int toAccNum, BigDecimal transferAmount) {
        ...
        Wallet fromAccount = dao.getAccountMap().get(fromAccNum);
        Wallet toAccount = dao.getAccountMap().get(toAccNum);
    ...
    public void statement(int accountNum) {
        Wallet account = dao.getAccountMap().get(accountNum);
        if(account == null) {
